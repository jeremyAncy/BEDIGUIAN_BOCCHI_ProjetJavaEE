		...
		<div id="list-musee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nomMusee" title="${message(code: 'musee.nomMusee.label', default: 'Nom Musee')}" />
					
						<g:sortableColumn property="telMusee" title="${message(code: 'musee.telMusee.label', default: 'Tel Musee')}" />
						...
						<g:sortableColumn property="horairesMusee" title="${message(code: 'musee.horairesMusee.label', default: 'Horaires Musee')}" />
