		...
		<div id="show-musee" class="content scaffold-show" role="main">
			...
			<ol class="property-list musee">
				...
				<li class="fieldcontain">
					<span id="nomMusee-label" class="property-label"><g:message code="musee.nomMusee.label" default="Nom Musee" /></span>
					
						<span class="property-value" aria-labelledby="nomMusee-label"><g:fieldValue bean="${museeInstance}" field="nomMusee"/></span>
				...
				<li class="fieldcontain">
					<span id="telMusee-label" class="property-label"><g:message code="musee.telMusee.label" default="Tel Musee" /></span>
					
						<span class="property-value" aria-labelledby="telMusee-label"><g:fieldValue bean="${museeInstance}" field="telMusee"/></span>
				...
				<li class="fieldcontain">
					<span id="horairesMusee-label" class="property-label"><g:message code="musee.horairesMusee.label" default="Horaires Musee" /></span>
					
						<span class="property-value" aria-labelledby="horairesMusee-label"><g:fieldValue bean="${museeInstance}" field="horairesMusee"/></span>
